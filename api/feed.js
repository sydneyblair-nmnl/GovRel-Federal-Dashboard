...
const RELEVANT_TERMS = [
  ...
  // space (science/space interest)
  'space','orbital','spacecraft','rocket','satellite','in orbit','launch vehicle','constellation','space station',
  // defense policy / alliances (catch budget & allied coverage without over-broad 'war'/'budget')
  'nato','allied','alliance','warfighting','wartime','fy27','fy2027','modernization','defense budget','supplemental',
];
